   ...
   return (
      <div className={"products"}>
         <Container>
            <Stack flexDirection={"column"} alignItems={"center"}
               ...
               <Stack className={"avatar-big-box"}>
                     ...
                     <input className={"search"} placeholder={"Type here"} value={searchText} 
                        onChange={(e) => {
                     ...
                     ></input>
                     <button className={"search-button"} onClick={searchProductHandler}>SEARCH
               ...
               <Stack className={"list-category-section"}>
                  <Stack className={"Product-category"}>
                     <div className={"category-main"}>
                        <Button className={"category-btn"} variant={"contained"} color={productSearch.productCollection === ProductCollection.OTHER ? "primary" : "secondary"}
                        onClick={() => searchCollectionHandler(ProductCollection.OTHER)}>
                           Other
                        </Button>
                        
                        <Button className={"category-btn"} variant={"contained"} color={productSearch.productCollection === ProductCollection.DESSERT ? "primary" : "secondary"}
                        onClick={() => searchCollectionHandler(ProductCollection.DESSERT)}>
                           Dessert
                        </Button>
                        
                        <Button className={"category-btn"} variant={"contained"} color={productSearch.productCollection === ProductCollection.DRINK ? "primary" : "secondary"}
                        onClick={() => searchCollectionHandler(ProductCollection.DRINK)}>
                           Drink
                        </Button>

                        <Button className={"category-btn"} variant={"contained"} color={productSearch.productCollection === ProductCollection.SALAD ? "primary" : "secondary"}
                        onClick={() => searchCollectionHandler(ProductCollection.SALAD)}>
                           Salad
                        </Button>

                        <Button className={"category-btn"} variant={"contained"} color={productSearch.productCollection === ProductCollection.DISH ? "primary" : "secondary"}
                           ...
                           return (
                              ...
                              > 
                                 <div className={"product-sale"}>
                                    <button className={"product-sale-button"}>{sizeVolume}</button></div>
                                 ...
                                 <Button className={"view-btn"} sx={{ left: "40px",
                                                                           color: "white" }}>
         ...
         <div className={"brands-logo"}>
               ...
               <Stack className="brand-logo-main">

               <Stack className={"brand-title"}>Our Family Brands</Stack>
               <Stack className={"brand-picture-wrapper"}>

                     <Stack className={"board-picture-holder"}>
            ...
            <Container>
               <Stack className={"address-area"}>
                  ...
                  <iframe 
                     ...
                     src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5992.778368347311!2d69.25423708987041!3d41.322149819104425!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8b6d7199ba8d%3A0x97b555a10e5f558e!2z0JzRg9C30LXQuSDQuNGB0YLQvtGA0LjQuCDRgdCy0Y_Qt9C4INCj0LfQsdC10LrQuNGB0YLQsNC90LA!5e0!3m2!1sru!2s!4v1753918104330!5m2!1sru!2s"
                     width="1320"
                     height="500"
